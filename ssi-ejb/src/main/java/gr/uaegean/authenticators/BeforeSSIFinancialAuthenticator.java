...
//    protected ParameterService paramServ = new ParameterServiceImpl();
    ...
    public void authenticateImpl(AuthenticationFlowContext context) {
        try {
            ...
            String resourceUrl = uportHelperMsHost + "/connectionRequest?" + "PERSONAL_FINANCIAL_STATUS=true&" + "ssiSessionId=" + ssiSessionId + "&callback=" + callback;
            ResponseEntity<String> response
                    = restTemplate.getForEntity(resourceUrl.trim(), String.class);

            resourceUrl = uportHelperMsHost + "/connectionRequestMobile?" + "PERSONAL_FINANCIAL_STATUS=true&" + "ssiSessionId=" + ssiSessionId
