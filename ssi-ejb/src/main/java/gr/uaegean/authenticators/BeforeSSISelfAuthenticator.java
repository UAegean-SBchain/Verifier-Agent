...
//    protected ParameterService paramServ = new ParameterServiceImpl();
    ...
    public void authenticateImpl(AuthenticationFlowContext context) {
        try {
            ...
            String resourceUrl = uportHelperMsHost + "/connectionRequest?" + "KEA_PERSONAL_DECLARATION=true&" + "ssiSessionId=" + ssiSessionId + "&callback=" + callback;
            ResponseEntity<String> response
                    = restTemplate.getForEntity(resourceUrl.trim(), String.class);

            resourceUrl = uportHelperMsHost + "/connectionRequestMobile?" + "KEA_PERSONAL_DECLARATION=true&" + "ssiSessionId=" + ssiSessionId
