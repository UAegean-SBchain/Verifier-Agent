...
//    protected ParameterService paramServ = new ParameterServiceImpl();
    ...
    public void authenticateImpl(AuthenticationFlowContext context) {
        try {
            ...
            String resourceUrl = uportHelperMsHost + "/connectionRequest?" + "Civil_Registry_ID=true&" + "ssiSessionId=" + ssiSessionId + "&callback=" + callback;
            ResponseEntity<String> response
                    = restTemplate.getForEntity(resourceUrl.trim(), String.class);

            resourceUrl = uportHelperMsHost + "/connectionRequestMobile?" + "Civil_Registry_ID=true&" + "ssiSessionId=" + ssiSessionId
